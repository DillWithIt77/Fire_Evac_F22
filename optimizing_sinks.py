...
# city names are 0 thru 499 for Tom's data
city_name='26'
...
'''
map the optimal evacuation shelter locations
'''
...
#orig_kpcoef.plot(ax=citymap, marker='o', color='black', markersize=10, label="origins")
...
minx, miny, maxx, maxy = dests_kpcoef.total_bounds
xdif=(maxx-minx)
ydif=(maxy-miny)
citymap.set_xlim(minx-xdif, maxx+xdif)
citymap.set_ylim(miny-ydif, maxy+ydif)

#turn of lat long axis numbers
citymap.axis("off")
